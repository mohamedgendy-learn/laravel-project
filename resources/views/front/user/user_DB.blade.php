...
<!-- Nucleo Icons -->
<link href="{{asset('user_DB/ssets/css/nucleo-icons.css')}}a" rel="stylesheet" />
<link href="{{asset('user_DB/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
...
<link id="pagestyle" href="{{asset('user_DB/assets/css/material-dashboard.css?v=3.0.4')}}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#" target="_self">
      <img src="{{asset('user_DB/assets/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">
      <span class="ms-1 font-weight-bold text-white">Educate</span>
    </a>
  </div>
...
<li class="nav-item">
  ...
  <div class="sidenav-footer position-absolute w-100 bottom-0 ">
    <div class="mx-3">
      <a class="btn bg-gradient-primary mt-4 w-100" href="{{route('coursespage')}}" type="button">Explore Courses</a>
    </div>
...
<script src="{{asset('user_DB/assets/js/plugins/perfect-scrollbar.min.js')}}" ></script>
<script src="{{asset('user_DB/assets/js/plugins/smooth-scrollbar.min.js')}}" ></script>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{asset('user_DB/assets/js/material-dashboard.min.js?v=3.0.4')}}"></script>
  </body>
