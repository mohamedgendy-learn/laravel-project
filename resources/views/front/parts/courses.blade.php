...
<div class="container-fluid px-0 py-5 wow bounceInRight" data-wow-duration="2s">
        ...
        <div class="owl-carousel courses-carousel">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('img/courses-4.jpg')}}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('img/courses-5.jpg')}}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset('img/courses-6.jpg')}}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
